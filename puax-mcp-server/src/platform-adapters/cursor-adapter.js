...
class CursorAdapter extends base_adapter_js_1.PlatformAdapter {
    constructor() {
        super('cursor', ['zh', 'en']);
    }
    /**
...
base_adapter_js_2.globalAdapterRegistry.register(new CursorAdapter());
