...
<p align="center">
  <img src="https://img.shields.io/badge/version-4.1.0-blue.svg" alt="Версия">
  ...
  <img src="https://img.shields.io/badge/MCP%20tools-49-purple.svg" alt="Инструменты MCP">
...
PUAX 4.1 — это **когнитивная среда выполнения (Cognitive Runtime)**, созданная специально для автономных ИИ-агентов. Роли — лишь тональные оттенки; настоящее ядро составляют три фундаментальных примитива:
...
- **Настройка в один клик Host Doctor**: `npx puax doctor --fix` устанавливает хуки для Cursor, Claude Code, VSCode, Windsurf.
