...
<p align="center">
  <img src="https://img.shields.io/badge/version-4.4.2-blue.svg" alt="Версия">
...
PUAX 4.3 — это **когнитивная среда выполнения (Cognitive Runtime)**, созданная специально для автономных ИИ-агентов. Роли — лишь тональные оттенки; настоящее ядро составляют три фундаментальных примитива:
