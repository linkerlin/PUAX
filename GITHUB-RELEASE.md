...
> **归档**：当前发行为 **4.0.0**。本文保留 3.0 发布稿，数字已经过时。请以仓库根 README 与 `puax-mcp-server/CHANGELOG.md` 为准。
>

## 概述

PUAX 3.0 是一个完整的 AI Agent 激励系统，通过自动检测触发条件、智能推荐角色、提供结构化方法论，帮助 AI Agent 突破瓶颈、提升表现。
