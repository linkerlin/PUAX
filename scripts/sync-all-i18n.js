...
const LANG_CONFIGS = [
  ...
  },
  {
    ...
    docTableAdd: "| [AMP Integration](docs/AMP-INTEGRATION.md) | Middleware-Integration für LangChain, Vercel AI SDK & LlamaIndex |\n| [Web Admin Spezifikation (Archiviert)](docs/WEB-ADMIN-SPEC.md) | [Archiviert] Konzentration auf Agent MCP; Web UI Erweiterung eingefroren |",
  },
  {
    file: "README_es.md",
  ...
  },
  {
    ...
    docTableAdd: "| [Интеграция AMP](docs/AMP-INTEGRATION.md) | Интеграция middleware для LangChain, Vercel AI SDK и LlamaIndex |\n| [Спецификация Web Admin (Архив)](docs/WEB-ADMIN-SPEC.md) | [Архив] Фокус исключительно на Agent MCP; веб-интерфейс заморожен |",
  },
];
...
zhMain = zhMain.replace(
  ...
  `$1| [Web Admin 设计（已封存）](docs/WEB-ADMIN-SPEC.md) | 【已废止】主公明敕坚守 Agent 原生接入 MCP 主轴，图形界面不予扩建 |\n`
);
